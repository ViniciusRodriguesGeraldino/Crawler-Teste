...
class PlayerDeathController extends Command {

    protected static $defaultName = 'app:player-death-controller';
    ...
    protected function execute(InputInterface $input, OutputInterface $output) {
        ...
        if($nome){
            ...
            dump('Lendo mortes do player ' . $nome);
            ...
            if ($players) {
                ...
                foreach ($players as $player) {
                    dump('Lendo mortes do player ' . $player->getNome());
                    $this->crawlerService->atualizaDeathsPlayer($player, $player->getLink());
                }
